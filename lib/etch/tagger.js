...
!function($){
    ...
    // arabic and hebrew, aztec is temporarily added for marketing team testing purpose
    var knownRightToLeft = ['ar', 'he', 'az'];
    ...
    var etTaggers = {
        ...
        languageAdditional: function(){
            ...
            if (isRtlLng(etInfo.lng)){
				this.set('et-lng-rtl');
                // add dir attribute to root also
                // because w3 suggested
                elRoot.attr('dir', 'rtl');
    ...
    etch.tagger = {
        ...
        tag: function(options){
            ...
            // options
            this.opts = {};
            $.extend(this.opts, defaultSettings, options);
