 ...
 * 
 * // or:
 * // below code snippet adds more etown specific info 
...
!function($){
    ...
    var defaultSettings = {
        more: {
			cookies:{
				// default cookie name for country and language info
				ctr: 'ctr',
				lng: 'lng'
			}
		}
    ...
    // arabic and hebrew, et marketing suggested to add az to rtl for testing purpose
    ...
    var etTaggers = {
        ...
        etownBasic: function(){
            ...
            var etInfo = getCookieInfo(this.opts.more.cookies);
